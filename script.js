...
const API_BASE = "https://script.google.com/macros/s/AKfycbyvq1DPqKUL7CjOu4PurKvlsF5Fd42oJcLvrGrd2Odj_d26JSp9VFs-7J1R6UIQ5SHb/exec";
...
const EQUIPMENT_IMAGES = {
    ...
    "Vacuum dressing": "https://drive.google.com/thumbnail?id=1z3ykHrO5AcJgD7sdwmVJ3UkOiQZewBxV",
    "Renasys": "https://drive.google.com/thumbnail?id=1jQPo08ziKdEb7QiZsgVZT-G6kA5Gz6WT",
    ...
    requests.forEach(item => {
        ...
        row.innerHTML = `
            ...
            <td data-label="Status" class="status-cell">
                ${item.status === 'pending' ?
                `<button class="btn primary btn-accept" data-id="${item.id}" type="button">รับเครื่อง</button>` :
...
function createMpcInput(value = "MPC-") {
    ...
    div.innerHTML = `
        ...
        <button type="button" class="btn secondary btn-remove-mpc">ลบ</button>
    `;
